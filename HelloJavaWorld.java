...
public class HelloJavaWorld {
	public static void main (String [] args) {
		...
		System.out.println(boolean temp = integerVariable == 3 || floatVariable == 3f); // returns true
		System.out.println(boolean tmp = integerVariable == 3 && floatVariable == 3f); // returns false

		int min = 1;
		int max = 10;
		int storeResult = ((int) (Math.random() * ((max - min) +1))) + min; // returns a number between 1 - 5;
		System.out.prinln('Random generated number = '+storeResult);
